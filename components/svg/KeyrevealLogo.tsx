...
export const KeyrevealLogo = memo((props: SVGProps<SVGSVGElement>) => (
	<svg width={57.547} height={52.003} viewBox="0 0 15.226 13.759" xmlns="http://www.w3.org/2000/svg" {...props}>
		<path
