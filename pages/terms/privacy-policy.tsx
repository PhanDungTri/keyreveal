...
const PrivacyPolicyPage: NextPage = () => (
	<>
		...
		<Container my="xl">
			<Card>
				<h1>Privacy Policy for KEYREVEAL</h1>

				<p>
					At KEYREVEAL, accessible from https://www.keyreveal.fun/, one of our main priorities is the privacy of our visitors. This Privacy Policy document
					contains types of information that is collected and recorded by KEYREVEAL and how we use it.
				</p>
				...
				<p>
					...
					and/or collect in KEYREVEAL. This policy is not applicable to any information collected offline or via channels other than this website. Our Privacy
					Policy was created with the help of the <a href="https://www.generateprivacypolicy.com/">Free Privacy Policy Generator</a>.
				</p>
				...
				<p>
					KEYREVEAL follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part
				...
				<p>
					...
					visit to www.website.com and other sites on the internet. However, visitors may choose to decline the use of DART cookies by visiting the Google ad
				...
				<p>You may consult this list to find the Privacy Policy for each of the advertising partners of KEYREVEAL.</p>
				...
				<p>
					...
					links that appear on KEYREVEAL, which are sent directly to users&apos; browser. They automatically receive your IP address when this occurs. These
				...
				<p>Note that KEYREVEAL has no access to or control over these cookies that are used by third-party advertisers.</p>

				<h2>Third Party Privacy Policies</h2>

				<p>
					KEYREVEAL&apos;s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies
				...
				<p>
					KEYREVEAL does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided
